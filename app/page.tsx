        ...
        <div className="flex lg:flex-row flex-col gap-4 items-center">
          <div className="space-y-4">
            ...
            <div className="flex flex-col gap-2 min-[400px]:flex-row">
              ...
              >
                <button className="inline-flex h-10 items-center justify-center rounded-md bg-primary px-8 text-sm font-medium text-primary-foreground shadow transition-colors focus-visible:outline-none focus-visible:ring-1 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50 hover:cursor-pointer hover:bg-gray-300">
                  <div>Sign In</div>
                </button>
              </form>
              <Link
