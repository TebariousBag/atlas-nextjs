...
export function SubmitAnswer({ questionId }: SubmitAnswerProps) {
  return (
    <form className="relative my-8" action={addAnswer}>
      ...
      <button
        type="submit"
        className="absolute right-2 bottom-2 flex h-10 w-24 items-center justify-center rounded-md border bg-secondary px-4 text-lg text-white hover:cursor-pointer hover:bg-teal-300 focus:bg-secondary"
      >
        Submit
      </button>
    </form>
